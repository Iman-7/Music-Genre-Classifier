...
UPLOAD_FOLDER = 'C:\\Users\\EMAN\Desktop\\FeaturesExtraction\\app\\static\\uploaded'
...
def output(name):
    ...
    # print(out)
    out = subprocess.check_output(['python', 'wav_input.py', name], shell = True).decode("utf-8")
    print("output from subprocess", out)
